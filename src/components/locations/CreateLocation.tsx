...
const CreateLocation = (props: CreateLocationProps) => {
  ...
  const { createLocationModal, setCreateLocationModal } = props;
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await api.createLocation({ name, region, country });
  ...
  return (
    <Modal
      ...
      onRequestClose={() => setCreateLocationModal(false)}
      style={{
        content: {
          width: "50%",
          height: "60%",
    ...
    >
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-lg font-semibold mb-6">Add Location</h2>
